...
$appointmentsQuery = "
    SELECT a.id, a.date, a.time, a.notes, 
           sp.id AS sp_id, 
           sp.first_name AS sp_first_name, 
           sp.last_name AS sp_last_name, 
           sp.email AS sp_email
    FROM appointment a
    LEFT JOIN users sp ON a.sp_id = sp.id
    WHERE a.cu_id = :user_id
    ORDER BY a.created_time DESC";
$appointmentsStmt = $conn->prepare($appointmentsQuery);
$appointmentsStmt->bindParam(':user_id', $_SESSION['user_id'], PDO::PARAM_INT);
    ...
    <section class="container">
        <div class="profile-header">
            <div class="profile-avatar">
                <img id="avatarImage" src="<?php echo htmlspecialchars($profileImagePath); ?>" alt="Profile Picture">
            </div>
            <div class="profile-info">
                <h1 id="profileName"><?php echo htmlspecialchars($customerName); ?></h1>
            ...
            <section class="profile-section">
                ...
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <div>
                            <label>Phone</label>
                            <p id="profilePhone"><?php echo htmlspecialchars($user['contact_number']); ?></p>
                        </div>
                    </div>
                    <div class="info-item">
                        <i class='bx bx-map'></i>
                        <div>
                            <label>Address</label>
                            <p id="profileAddress"><?php echo htmlspecialchars($user['address']); ?></p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                <div class="field">
                                    ...
                                    <span id="sp_id"><span
                                            id="sp_id"><?php echo $appointment['sp_first_name'] . ' ' . $appointment['sp_last_name']; ?></span></span>
                                </div>
                                <div class="field">
                                    <label>Date :</label>
                                ...
                                <div class="field">
                                    <span class="edit-btn"
                                        onclick="openEditModal(<?php echo $appointment['id']; ?>, '<?php echo $appointment['date']; ?>', '<?php echo $appointment['time']; ?>', '<?php echo htmlspecialchars($appointment['notes']); ?>')"><i
                                            class='bx bx-edit-alt'></i></span>
                                    <span class="delete-btn"
                                        onclick="deleteAppointment(<?php echo $appointment['id']; ?>)"><i
