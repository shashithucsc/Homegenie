...
<body>
    ...
    <div id="appointmentModal" class="modal">
        <div class="modal-content">
            ...
            <button class="login-btn" onclick="document.location='<?php echo URLROOT; ?>/LoginController/index?redirect=HomeController/SPProfile/<?php echo htmlspecialchars($provider->user_id); ?>'">Login</button>
        </div>
    </div>
