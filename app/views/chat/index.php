...
<?php require_once APPROOT . '/views/Customer/loggedNavBar.php'; ?>
    ...
    <div class="chat-header">
        <div class="user-info">
            <img src="<?php echo URLROOT; ?>/public/img/profile/<?php echo $data['other_user']->profile_pic; ?>" alt="Profile Picture" class="profile-pic">
            <h2><?php echo $data['other_user']->first_name . ' ' . $data['other_user']->last_name; ?></h2>
        </div>
        <a href="<?php echo URLROOT; ?>/CustomerController/cu_appointment" class="back-btn"><i class='bx bx-arrow-back'></i> Back to Appointments</a>
    </div>
